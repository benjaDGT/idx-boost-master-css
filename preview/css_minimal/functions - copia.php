...
#header.page-frontpage .wrap-menu{ '.$color_home.' }
    
#header.page-innerpage .wrap-options, 
#header.page-innerpage .wrap-menu{ '.$color_inner_pages.' }   
...
.wrap-result.view-grid .result-search .propertie .wrap-slider .next,
.wrap-result.view-grid .result-search .propertie .wrap-slider .prev{
  background: '.$color_primary.'99 !important;
}
...
#header .wrap-options .gwr #available-languages:after {
	border-top-color: 7px solid '.$color_primary.';
}

.clidxboost-sc-filters #filter-save-search{
	background: '.$color_primary.' !important;
}
...
.clidxboost-full-slider .gs-next-arrow, 
.clidxboost-full-slider .gs-prev-arrow,
...
.form-content .gform_body .gform_button:hover,
.form-content .gform_footer .gform_button:hover,
#menu-main .sub-menu li a:hover, .form_content .btn_form:hover, 
#full-main .title-conteiner .content-fixed .content-fixed-title .breadcrumb-options .btn-request:hover, 
#header-filters .text-wrapper .allf-ss, .group-flex li.active a:hover, 
.group-flex li.active button:hover, 
.group-flex li:hover a, 
.group-flex li:hover button, 
...
.page-deployed .clidxboost-btn-link span:hover,
