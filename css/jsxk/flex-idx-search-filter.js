    ...
    */
    ...
    if (IB_LB_AMENITIES_OPTIONS.length) {
        IB_LB_AMENITIES_OPTIONS.each(function (index, node) {
            ...
            else if (__flex_idx_search_filter.search.amenities[i].name=="Water Front")
            ...
            else if (__flex_idx_search_filter.search.amenities[i].name=="Short Sales")
                text_label_trans=word_translate.short_sales;
            else if (__flex_idx_search_filter.search.amenities[i].name=="Foreclosures")
