<?php get_header();
$data = dgt_load_neighborhoods_fn(false);
		...
		<header>
			<div class="gwr">
				<div class="title-header">
					<h1> <?php echo __('Miami Featured Neighborhoods', IDXBOOST_DOMAIN_THEME_LANG);?></h1>
				</div>
				...
				<div id="wrap-breacrumb">
					<div class="gwr">
						<ol id="breacrumb">
							...
							<li><?php echo __('Neighborhoods', IDXBOOST_DOMAIN_THEME_LANG);?></li>
						</ol>
					</div>
				</div>
			</div>
