  ...
  $('.neighborhood_select').change(function(){
    ...
    if ( ( get_neighborhood_show.length==0 || mobileAndTabletcheck() ) || neighborhood_select_value=='all' ) {
      ...
      /*if ($("body").hasClass("view-map")) {
        $("html, body").scrollTop(0);
        var offsetIdPositionMap = 0; 
        var sectionIdMap = $("#wrap-list-result #"+hash_neig);
        var offsetIdMap = sectionIdMap.offset();
        offsetIdPositionMap = offsetIdMap.top + ($("#wrap-list-result #"+hash_neig).outerHeight() / 2);
        $("#wrap-list-result").animate({ scrollTop: offsetIdPositionMap }, 900);
      }*/
      ...
      if (hash_neig != '') {
        ...
        var offsetIdPosition = 0, offsetIdPositionMap = 0; 
