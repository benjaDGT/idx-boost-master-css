...
Handlebars.registerHelper("idxGalleryImages", function(property) {
    if (property.gallery.length > 0) {
        ...
        for (var i = 0, l = property.gallery.length; i < l; i++) {
            if (i < 1) {
                images.push('<img onerror="this.src=\'https://www.idxboost.com/i/default_thumbnail.jpg\';" src="'+property.gallery[i]+'" class="ib-pifimg">');
            } else {
                images.push('<img onerror="this.src=\'https://www.idxboost.com/i/default_thumbnail.jpg\';" data-lazy="'+property.gallery[i]+'" class="gs-lazy">');
            }
        }
    ...
    return function() {
        ...
        if (property.group.length > 1) {
            ...
            for (var i = 0, l = property.group.length; i < l; i++) {
                ...
                infobox_content.push('<li class="ib-ibditem ib-ibbaths"><span class="ib-ibdbold">'+_.formatAcres(property_group.lot_size)+'</span> Lot Size</li>');
                ...
                infobox_content.push('<div class="ib-ibpb"><img onerror="this.src=\'https://www.idxboost.com/i/default_thumbnail.jpg\';" class="ib-ibimg" src="'+property_group.thumbnail+'"></div>');
            ...
            infobox_content.push('<li class="ib-ibditem ib-ibbaths"><span class="ib-ibdbold">'+_.formatAcres(property.item.lot_size)+'</span> Lot Size</li>');
...
function buildMobileForm() {
    ...
    if (ib_m_features.length) {
        ...
        for(var i = 0, l = ib_search_filter_dropdown.length; i < l; i++) {
            ...
            }else if ( option.name=="Water Front"){
...
function buildSearchFilterForm() {
    ...
    if (IB_LB_AMENITIES_OPTIONS.length) {
        IB_LB_AMENITIES_OPTIONS.each(function (index, node) {
            ...
            else if (__flex_idx_search_filter_v2.search.amenities[i].name=="Short Sales")
                text_label_trans=word_translate.short_sales;
            else if (__flex_idx_search_filter_v2.search.amenities[i].name=="Foreclosures")
...
function handleFilterSearchLookup(event) {
    ...
    ib_xhr_handler = $.ajax({
        ...
        success: function(response) {
            ...
            // console.dir(params.min_beds);
            // console.dir(params.max_beds);

            // console.log(null === params.min_beds);
            // console.log("" === params.min_beds);
